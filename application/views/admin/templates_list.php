<div class="pxg_admin_content">
                ...
                <header class="pxg_header_wrapper">
                    ...
                    <div class="pxg_header_heading">
                        <h4><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_1')); ?></h4>
                    </div>
                    <div class="pxg_hdr_right_content">
                        <div class="pxg_hdr_rgt_inner_content">
                            <div class="search_wrapper">
                                <input type="text" class="search_q" value="<?= $search ?>" placeholder="Digite a palavra-chave">
                                <span class="search_icn">
                                <img src="<?= base_url() ?>assets/images/svg/search.svg" alt="<?php echo html_escape($this->lang->line('ltr_admin_templates_alt_1')); ?>">
                                </span>
                            </div>
                            <a href="javascript:;" class="pxg_btn ppa_add_template" data-bs-toggle="modal" data-bs-target="#pxg_create_update_template_model">
                            <?php echo html_escape($this->lang->line('ltr_admin_templates_txt_2')); ?>
                            </a>
                        </div>
                    </div>
                </header>
                ...
                <div class="pxg__inner_content pxg_all_template_list_main">
                    <div class="pxg_header_heading">
                        ...
                        <h4><?= (!empty($search)? 'Palavra-chave da pesquisa - "'.$search.'"': '') ?> </h4>
                    </div>
                     <!-- Template Section Start -->
                    <?php if( !empty( $templates_list ) ){ ?>
                        <div class="pxg_template_list pxg_d_template_container" data-offset="<?= $count ?>" >
                            <!----------Template Content-------->
                            <?php foreach( $page_info['data']['templates_list'] as $key => $value ) { 
                                echo $this->common->dfyTempElementAdmin($value);
                            } ?>
                            <!----------Template Content-------->
                        </div>
                    <?php } else {  ?>
        ...
        <div class="modal pxg_common_model pxg_add_temp_popup fade" id="pxg_add_temp_model" data-bs-keyboard="false" tabindex="-1" aria-labelledby="basicModal" aria-hidden="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="basicModal"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_7')); ?></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <img src="<?= base_url() ?>assets/images/cancel-icon.svg" alt="<?php echo html_escape($this->lang->line('ltr_admin_templates_alt_4')); ?>">
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="pxg_main_input">
                                <label><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_8')); ?></label>
                            ...
                            <div class="pxg_model_btn">
                                <a class="pxg_btn" data-bs-dismiss="modal"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_9')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal pxg_common_model pxg_create_user_popup fade" id="pxg_create_update_template_model" data-bs-keyboard="false" tabindex="-1" aria-labelledby="basicModal" aria-hidden="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <form id="createupdatetemp_form" data-posturl="ajax/addUpdateTemplateZip">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title ppa_userAddUpdateModal" id="basicModal"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_10')); ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                <img src="<?= base_url() ?>assets/images/cancel-icon.svg" alt="<?php echo html_escape($this->lang->line('ltr_admin_templates_alt_5')); ?>">
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="pxg_main_input">
                                    <label><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_11')); ?></label>
                                    <input class="pxg_custom_input require" data-error="O nome do modelo é obrigatório" type="text" placeholder="Digite o nome aqui" name="ppd_template_name" value="" autocomplete="off">
                                </div>
                                <div class="pxg_main_input ppd_template_zip_field">
                                    <h6 class="pxg_input_lbl"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_12')); ?></h6>
                                    <label class="pxg_upload">
                                        <input data-error="O zip do modelo é obrigatório" type="file" onchange="$(this).siblings('p').text( $(this)[0].files[0].name )" placeholder="Digite o e-mail aqui" name="ppd_template_zip"  class="d-none">
                                        <span><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_13')); ?></span>
                                        <p><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_14')); ?></p>
                                    </label>
                                </div>
                                <div class="pxg_main_input">
                                    <h6 class="pxg_input_lbl"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_15')); ?></h6>
                                    <label class="pxg_upload">
                                        <input data-error="A miniatura do modelo é obrigatória" type="file" onchange="$(this).siblings('p').text( $(this)[0].files[0].name )" placeholder="Digite o e-mail aqui" name="ppa_template_thumbnail"  class="d-none">
                                    ...
                                    <p style="color:#112650;font-size: 13px;line-height: 1.6;"><strong><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_18')); ?>:</strong> <?php echo html_escape($this->lang->line('ltr_admin_templates_txt_19')); ?> 360 x 180 </p>
                                </div>
                                <div class="pxg_main_input">
                                    <label>O usuário pode baixar o site</label>
                                    <td class="pxg_tb_switch">
                                        <label class="pxg_switch_toggle">
                                            <input type="checkbox" name="ppd_template_downloadable" class="pxg_switch_inpt">
                                ...
                                <div class="pxg_model_btn">
                                    <a class="pxg_btn" data-action="submitMe" data-form="createupdatetemp_form"><?php echo html_escape($this->lang->line('ltr_admin_templates_txt_20')); ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
