        ...
        return _inherits(C, Emitter), _createClass(C, null, [{
            ...
            value: function(r, e, t, n, o) {
                ...
                return this.createThumbnail(r, e, t, n, !0, function(e, t) {
                    ...
                    return "image/webp" !== n && "image/webp" !== n || (i = ExifRestore.restore(r.dataURL, i)), o(C.dataURItoBlob(i))
                })
            }
        }, {
            key: "createThumbnail",
...
var detectVerticalSquash = function(e) {
    ...
    ExifRestore = function() {
        ...
        return _createClass(e, null, [{
            ...
            key: "restore",
            value: function(e, t) {
                if (!e.match("data:image/webp;base64,")) return t;
                var n = this.decode64(e.replace("data:image/webp;base64,", "")),
                    i = this.slice2Segments(n),
                    r = this.exifManipulation(t, i);
                return "data:image/webp;base64,".concat(this.encode64(r))
            }
        }, {
            ...
            key: "insertExif",
            value: function(e, t) {
                var n = e.replace("data:image/webp;base64,", ""),
                    i = this.decode64(n),
                    r = i.indexOf(255, 3),
                    o = i.slice(0, r),
                    a = i.slice(r),
